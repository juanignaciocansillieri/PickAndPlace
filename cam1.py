...
lblTitulo = Label(root,text="PICK & PLACE",justify=CENTER,font=("Roboto", 50))
lblTitulo.place(x=500, y=50)

btnIniciar = Button(root, text="Calibrar",width=45,command=iniciar)
btnIniciar.place(x=520,y=150)


lblVideo2 = Label(root)
lblVideo2.place(x=500,y=200,height=480,width=640)
